 ...
 * by running two threads simultaneously, one to enqueue a preset number
 * of customers and then serve them in order. Second thread allows user 
 * to input new arrivals to the line. User can close the line at any time. 
...
class Application {
	...
	public static void main(String[] args) { 
		...
		// Thread to allow user to put new customers in the line.
